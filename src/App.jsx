...
const gmailSendV51=(subject,body,to="")=>window.open("https://mail.google.com/mail/?view=cm&fs=1&to="+encodeURIComponent(to)+"&su="+encodeURIComponent(subject)+"&body="+encodeURIComponent(body),"_blank");
...
function App(){
  ...
  return <div className="app">
    <aside className="side"><div className="brand"><b>CONTROL D'OBRES</b><span>V51 estable</span></div>
